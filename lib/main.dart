...
//   String aiQuestion = '';
//   String aiAnswer = '';
//   Map<String, List<String>> aiAnalysisWords = {
//     'general': [],
//     'news': [],
//     'fundamental': [],
//     'team': [],
//   };
//   Map<String, int> aiAnalysisCurrentWordIndex = {
//     'general': 0,
//     'news': 0,
//     'fundamental': 0,
//     'team': 0,
//   };
//   Map<String, Timer?> aiAnalysisTimers = {};

//   List<String> aiAnswerWords = [];
//   int aiAnswerCurrentWordIndex = 0;
//   Timer? aiAnswerTimer;
...
//     _tabController.dispose();
//     _scrollController.dispose();
//     aiAnalysisTimers.forEach((_, timer) => timer?.cancel());
//     aiAnswerTimer?.cancel();
//     super.dispose();
//   }
...
//     try {
//       final analysis = await AIService.generateComprehensiveAnalysis(widget.cryptocurrency);
//       aiAnalysis.forEach((key, _) {
//         aiAnalysisWords[key] = analysis[key]!.split(' ');
//         aiAnalysisCurrentWordIndex[key] = 0;
//         startAIAnalysisTimer(key);
//       });
//     } catch (e) {
//       _showErrorSnackbar('Failed to fetch AI analysis');
//     }
...
//   void startAIAnalysisTimer(String key) {
//     aiAnalysisTimers[key]?.cancel();
//     aiAnalysisTimers[key] = Timer.periodic(const Duration(milliseconds: 50), (timer) {
//       if (aiAnalysisCurrentWordIndex[key]! < aiAnalysisWords[key]!.length) {
//         setState(() {
//           aiAnalysis[key] = aiAnalysisWords[key]!.sublist(0, aiAnalysisCurrentWordIndex[key]! + 1).join(' ');
//           aiAnalysisCurrentWordIndex[key] = aiAnalysisCurrentWordIndex[key]! + 1;
//         });
//       } else {
//         timer.cancel();
//       }
...
//       aiAnswer = '';
//       aiAnswerWords = [];
//       aiAnswerCurrentWordIndex = 0;
//     });
//     try {
//       final answer = await AIService.generateAIResponse(
//         "Answer this question about ${widget.cryptocurrency.name} (${widget.cryptocurrency.symbol}) as of ${DateFormat('yyyy-MM-dd HH:mm:ss').format(DateTime.now())}: $aiQuestion"
//       );
//       aiAnswerWords = answer.split(' ');
//       startAIAnswerTimer();
//     } catch (e) {
//       setState(() => aiAnswer = 'Failed to get AI response');
//     }
...
//   void startAIAnswerTimer() {
//     aiAnswerTimer?.cancel();
//     aiAnswerTimer = Timer.periodic(const Duration(milliseconds: 50), (timer) {
//       if (aiAnswerCurrentWordIndex < aiAnswerWords.length) {
//         setState(() {
//           aiAnswer = aiAnswerWords.sublist(0, aiAnswerCurrentWordIndex + 1).join(' ');
//           aiAnswerCurrentWordIndex++;
//         });
//       } else {
//         timer.cancel();
//       }
