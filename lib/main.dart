...
class _CryptocurrencyAIQATabState extends State<CryptocurrencyAIQATab> {
  ...
  Future<void> askAIQuestion() async {
    ...
    try {
      // Include live data in the AI prompt
      ...
      with current data as of ${DateFormat('yyyy-MM-dd HH:mm:ss').format(DateTime.now())}:
      ...
      setState(() => aiAnswer = 'Failed to get AI response: $e');
    }
  }
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          _buildLiveDataCard(),
          const SizedBox(height: 16),
          const Text('Ask AI about this Cryptocurrency', 
